...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Learning full-stack web development by building real, working products instead of just tutorials.",
      "Built and shipped a POS system for AC service booking (Proactive) covering scheduling, dispatch, and checkout.",
      "Built a separate POS system for a retail store (Sasaday Mart) to handle everyday checkout and stock tracking.",
      "Still learning — focused on writing clean code, understanding how the pieces fit together, and improving with every project.",
    ],
    skills: [
      SkillNames.NEXTJS,
      SkillNames.TS,
  ...
  },
  {
    ...
    description: [
      "Started exploring IoT by connecting sensors to a hydroponic system and building a dashboard to read the data.",
      "Built Stempra, a real-time dashboard showing water and nutrient conditions from a hydroponic setup.",
      "Also built a small LMS for German lessons and a QRIS scanner to check payment code authenticity — different problems, same habit of building things to learn how they work.",
      "Still a beginner, but getting more comfortable turning an idea into something people can actually use.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.VUE,
